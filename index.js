...
// but also modify the this value of the functions passed through
//  while ensuring arguments are properly passed.
//
...
function returnNewFunctionOf(functionToBeCopied, thisValue){
  return functionCopy = functionToBeCopied.bind(thisValue)
}
